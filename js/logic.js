(function(w, d) {
    function board(width, height) {
        ...
        this.config = {
            ...
            moveSpeed: 150,
            runSpeed: 15,
            colors: ["#F90D36", "#0CF44A", "#FCBB08", "#188FF5"],
            snakeLadderLayer: "images/Board.png",
            snakes: [{s: 40,e: 3}, {s: 27,e: 5}, {s: 43,e: 18}, {s: 54,e: 31}, {s: 99,e: 41}, {s: 66,e: 45}, {s: 89,e: 53},{s: 76,e: 58}],
            ladders: [{s: 4,e: 25}, {s: 13,e: 46}, {s: 33,e: 49}, {s: 42,e: 63}, {s: 50,e: 69}, {s: 62,e: 81}, {s: 74,e: 92}]
        };
        this.state = {
            playerCount: 0,
            turn: 0
    ...
    b.init = function() {
        ...
        var img = new Image('images/dice0.gif');
        img = new Image('images/dice1.png');
        img = new Image('images/dice2.png');
        img = new Image('images/dice3.png');
        img = new Image('images/dice4.png');
        img = new Image('images/dice5.png');
        img = new Image('images/dice6.png');
    }
